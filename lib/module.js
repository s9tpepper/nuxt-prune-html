...
function shouldPrune(headers, options) {
    ...
    */
    if( isTypeDefaultDetect && headers && headers[ options.headerNameForDefaultDetection ] ) {
        console.log(`headers[ ${options.headerNameForDefaultDetection} ]: ${headers[ options.headerNameForDefaultDetection ]}`)
        ...
        console.log(`shouldPruneFromBotAuditOrMobileDetection: ${shouldPruneFromBotAuditOrMobileDetection}`)
    }
    ...
    */
    if( isTypeQueryParameters && _parsedUrl ) {
        ...
        // Should prune?
        console.log(`isTypeQueryParameters :: shouldExcludePrune: ${shouldExcludePrune}`)
        ...
        console.log(`shouldPruneFromQueryParameter: ${shouldPruneFromQueryParameter}`)
    ...
    */
    if( isTypeHeaders && headers ) {
        ...
        // Should prune?
        console.log(`isTypeHeaders :: shouldExcludePrune: ${shouldExcludePrune}`)
        if( shouldExcludePrune )
            return false;
        ...
        console.log(`shouldPruneFromHeaderExist: ${shouldPruneFromHeaderExist}`)
    }
